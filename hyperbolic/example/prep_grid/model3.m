...
if flag_printf
    ...
    text(200.0+10, -100.0+20,'R3',FontSize=15);
    text(300.0+10, -100.0+20,'R4',FontSize=15);
    text(400.0+10, -100.0+20,'R5',FontSize=15);
    text(400.0+10, -0.0  +20,'R6',FontSize=15);
    text(500.0+10, -0.0  +20,'R7',FontSize=15);
...
%     title('concave step model',FontSize=15);
    ...
    text(50,-150,'Vp=3.0 km s^{-1}',FontSize=15);
    text(50,-200,'Vs=2.0 km s^{-1}',FontSize=15);
    text(50,-250,'\rho=1.5 g cm^{-3}',FontSize=15);
end
